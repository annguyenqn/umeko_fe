                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {set.description && (
                                                        <p className={`text-sm mt-1 ${selectedSet?.id === set.id
                                                            ? 'text-blue-100'
                                        ...
                                        <AnimatePresence>
                                            {filteredWords.map((entry, index) => (
                                                <motion.div
                                                    ...
                                                    className="p-4 rounded-lg border transition-all hover:shadow-md bg-gray-50 border-gray-200 dark:bg-gray-700 dark:border-gray-600"
                                                >
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex-1">
                                                            <div className="flex items-center space-x-3 mb-2">
                                                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">{entry.word}</h3>
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Tạo tệp từ vựng mới</h3>
                                    <button
                                        onClick={() => setIsCreateSetOpen(false)}
                                ...
                                <div className="flex space-x-3 mt-6">
                                    <button
                                        onClick={() => setIsCreateSetOpen(false)}
                                        className="flex-1 px-4 py-2 rounded-lg border transition-colors border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
                                    >
                                        Hủy
                                    </button>
                                    <button
                ...
                <AnimatePresence>
                    {isAddWordOpen && selectedSet && (
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Thêm từ vựng mới</h3>
                                    <button
                                        onClick={() => setIsAddWordOpen(false)}
                                        className="p-1 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-gray-900 dark:text-white"
                                    >
